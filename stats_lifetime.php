...
echo "<tr>";
echo "\n";
echo "  <th class=tg1><b>" . $hcolor . "Top 10s: </font></b>" . number_format($top10s) . "</th>";
echo "\n";
...
echo "<tr>";
echo "\n";
echo "  <th class=tg1><b>" . $hcolor . "Assists: </font></b>" . number_format($assists) . "</th>";
echo "\n";
...
echo "<tr>";
echo "\n";
echo "  <th class=tg1><b>" . $hcolor . "dBNOs: </font></b>" . number_format($dBNOs) . "</th>";
echo "\n";
...
echo "<tr>";
echo "\n";
echo "  <th class=tg1><b>" . $hcolor . "Losses: </font></b>" . number_format($losses) . "</th>";
echo "\n";
echo "  <th class=tg1><b>" . $hcolor . "Matches: </font></b>" . number_format($roundsPlayed) . "</th>";
...
echo "<tr>";
echo "\n";
echo "  <th class=tg1><b>" . $hcolor . "Revives: </font></b>" . number_format($revives) . "</th>";
echo "\n";
