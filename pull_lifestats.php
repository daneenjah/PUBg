...
$user = $_GET['user'];//set user from url
...
function getLifetime(){
    ...
    $myFile = "data/".$user."/".$user."_lifetime.json";//set up our file name
    ...
    //setup out URL for curl
    curl_setopt($ch, CURLOPT_URL,"https://api.pubg.com/shards/$platform/players/$account/seasons/lifetime");
    //set a timeout, because PUBg API can hang randomly
    curl_setopt($ch, CURLOPT_TIMEOUT, 4);
    //set out headers
    curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
